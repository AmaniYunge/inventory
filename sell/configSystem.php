...
<!-- home -->
   ...
   <form name="for10" action="../index.php" method="post" >
    ...
    <input type="hidden" name="use" value="<?php echo $user; ?>" /> 
      ...
      <form name="for12"  class="noprint" action="" method="post" >
    ...
    <form name="for15" action="" method="post" >
    <input type="hidden" name="dir" value="tbl" />
    <input type="hidden" name="use" value="<?php echo $user; ?>" /> 
    </form>
    <form name="for16" action="" method="post" >
...
function contact()
            {
             ...
             <caption style="color:#009; font-size:18px;">information</caption>
              ...
              <tr><td>designer:</td><td> Petro c Bilingi</td></tr>
             
              <tr><td>telephone:</td><td> +255 654610040</td></tr>
        
              <tr><td>place:</td><td> Der Es Salaam,Luguruni</td></tr>
              </table>
              </center-->
<?php }	
function logout(){
...
?>
	<form id='from' class='notprint' action="<?php echo $PHP_SELF;  ?>" method="post">
from<input id="bday"  type="text" placeholder="date" name="bday" />
to:<input id="to"  type="text" placeholder="date" name="to" />
<input type="submit" name="send" value="Enter" />
<input type="hidden" name="dir" value="cst" />
...
<form action="" method="post" id="menu" >
    <ul class="menu" id="notprint">
       ...
       <!--li><a href="#"  onclick="document.forms[1].submit();return false;"><span>Report</span></a></li-->
         <li ><a href="#" onclick="document.forms[6].submit();return false;"><span>customer </span></a></li>
  ...
  <li ><a href='#' onclick="document.forms[8].submit();return false;"><span >Debt</span></a></li>
   <li ><a href='#' onclick="document.forms[12].submit();return false;"><span >Bank</span></a></li>
    <li ><a href='#' onclick="document.forms[15].submit();return false;"><span >TBL</span></a></li>
      <li ><a href='#' onclick="document.forms[16].submit();return false;"><span >salesman</span></a></li>
  ...
  <!--li ><a href='#' onclick="document.forms[9].submit();return false;"><span >Import</span></a></li>

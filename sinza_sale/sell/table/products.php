...
echo "<div id='print'><table border='0' id='tab'  style='border-collapse:collapse; width:300px; border-right:1; font-size:19;'>
...
VALUES (
NULL , '$id', '$add', '$cost', '$lastid', CURDATE( ) , CURTIME( ),'$profit'
);");
...
<!--form name="form1" action="<?php echo $PHP_SELF; ?>" method="post"  onsubmit="return chek();"-->
        ...
        if(a==''<?php chekJs();?>){
         ...
         <style type="text/css">
#items { border:none; }
#items ul li input { position:absolute; right:1px; text-align:center; ;}
           ...
           for (i = 0; i <len; i++)
			...
			//alert(id);
                if (inputs[i].type == "text" && inputs[i].value != ""  )
                {
					...
					sum=sum+price;
					valueid=valueid+inputs[i].getAttribute("name")+"-";
					// alert ( sum+" "+price ) ;
                }
}
			...
			document.getElementById("dataid").value=valueid;
...
<!--li >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;total<input id="sum" type="text" name="phone" value=""
 name="sum"/></li>
 <li >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;customer name:<input id="name" type="text" name="name" value=""
 name="sum"/><br/></li-->
 <li><button class="css_btn_class" type="submit" onclick=" " name="order" value="order" >submit</button></li>

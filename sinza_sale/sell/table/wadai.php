...
mysql_query("UPDATE `moshi_db`.`wadai` SET `balance` = '$balance' WHERE `wadai`.`wadai_name` ='$_POST[id]'  ORDER BY id DESC LIMIT 1 ;");
	...
	?>
 <button onclick="$('#dep').toggle();">RECIEVED AMOUNT</button> <button onclick="$('#trans').toggle();">PAY</button>
...
<?PHP			
     ...
     <tr bgcolor='#C9CED3'><td >DATE</td><td>NAME</td><td>RECIEVED AMOUNT</td><td> PAID AMOUNT</td><td>BALANCE</td>
  </tr>
  ";
  $paid="";
  $cost="";

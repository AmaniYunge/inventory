...
if($date){
 ...
 if(!$date1){
	 ...
	 $d="from&nbsp;&nbsp;". $datemysql."&nbsp;&nbspto&nbsp;&nbsp ".$datemysqlto."<br />";
	 }
...
$d="".  date("Y-m-d")."<br />";
							...
							echo"<center><h3>SALES REPORT <br/> date $d </h3></center>
...
if($cat !=""){
			...
			<tr  align='right' height='17px' style='font-size:12px; background-color:#fff; font:bold; color:#006; border:thin solid #ccc;' >
							...
							$cost_t=0;
							$pro_t=0;
								$query=mysql_query("SELECT * FROM data where ct='$cat'  ");	
						 ...
						 $name=$rows['nm'];
						  ...
						  if($import>0){
							...
							echo"<tr style='$td_color border:thin #ccc solid;' >
						                     ...
						                     <td style='border:thin solid #ccc;' align='center'>".$original."</td>
							                  <td style='border:thin solid #ccc;' align='center'>".$import ." </td>
											    
							                  <td style='border:thin solid #ccc;' align='center'>" .$qt ."</td>	
											   <td style='border:thin solid #ccc;' align='center'>" .$stock ."</td>	
	...
	echo"<tr  align='right' height='28px' style='font-size:16px; background-color:#D8EBE7; font:bold; color:#006; border:thin solid #ff0;' >
							...
							echo"
							<center><h3>SALES REPORT <br/> date $d </h3></center>
						 ...
						 $name=$rows['nm'];
						  ...
						  if($import>0){
							...
							echo"<tr style='$td_color border:thin #000 solid;' >
						                     ...
						                     <td style='border:thin solid #000;' align='center'>".$original."</td>
							                  <td style='border:thin solid #000;' align='center'>".$import ." </td>
											    
							                  <td style='border:thin solid #000;' align='center'>" .$qt ."</td>	
											   <td style='border:thin solid #000;' align='center'>" .$stock ."</td>	

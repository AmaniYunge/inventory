	...
	//if($_POST[$idnm] !="")
       //  {
		 ...
		 $bgcol="background-color:#C8F2BB; color:#000;";
			  ...
			  <td align='center'><input id='cashvalue$j' class='cashvalue' price='$price' reja='$reja'  type='text' name='$idnm' value='' /></td>
...
<td  align='right'>customer name:<input type='text' id="nameenter"  name='name'  value='' onfocus="OnFocusInput ('price')" /></td>
<td></td>
<td align='right'></td>
<td ></td>
<td ></td>

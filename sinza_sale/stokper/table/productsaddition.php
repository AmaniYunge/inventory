    ...
    $bgcol="background-color:#C8F2BB";
		 ...
		 $bgcol="background-color:#fff; color:#000;";
			  ...
			  <td align='center'><input align='right' type='text' name='$idby' value='$by' /></td>
			   <td align='center'><input align='right' type='text' name='$idbuyprice' value='$buyprice' /></td>
			  </tr>"; 
...
<td  > Category</td>
<td >Unity</td>
<td align='right'>whole sale price </td>
...
<td align='right'>".number_format($idbuyprice)."</td>
</tr>";
$no=$no+1;
